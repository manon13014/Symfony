 ...
 */
final class Version20240604151217 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ALTER created_at SET DEFAULT \'2024-06-04 10:02:58.899355\'');
        $this->addSql('ALTER TABLE category ALTER created_at SET DEFAULT \'2024-06-04 10:02:58.899355\'');
